...
def plot_exchange_rates(max, min, mean, currency, y_ticks=None):
    ...
    fig.update_layout(
        ...
        yaxis=dict(tickfont=dict(size=18, color="black"), dtick=y_ticks, gridcolor="white"),
        showlegend=True,
        legend=dict(
            orientation="h",
            yanchor="bottom",
        ...
        xaxis=dict(tickangle=45, tickfont=dict(size=18, color="black"), dtick="M12", gridcolor="white"),
        plot_bgcolor="grey",
